...
class Decompilation:
    """
    Represents the decompilation of a program.

    Attributes:
        text (str): The decompiled text.
        asm (list): The assembly code.
        json (dict): The decompiled data in JSON format.
    """
    text: str = ""
...
def decompile_bytecode(code: str, only_func_name=None) -> Decompilation:
    """
    Decompiles bytecode and returns the decompilation result.

    Args:
        code (str): The bytecode to decompile. It should be in hexadecimal format.
        only_func_name (str, optional): If provided, only decompiles the function with the specified name.

    Returns:
        Decompilation: The decompilation result.
...
def decompile_address(address: str, only_func_name=None) -> Decompilation:
    """
    Decompiles the contract at the specified address and returns the decompilation result.
...
def _decompile_with_loader(loader, only_func_name=None) -> Decompilation:
    """
    Internal function to perform the decompilation using the provided loader.

    Args:
        loader (Loader): The loader object containing the disassembled code and function list.
        only_func_name (str, optional): If provided, only decompiles the function with the specified name.
    ...
    with redirect_stdout(text_output):
        ...
        print(C.gray + "# Panoramix decompiler. " + C.end)
